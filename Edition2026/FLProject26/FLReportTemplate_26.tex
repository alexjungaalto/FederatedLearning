...
necessary data files. The script must be executable on \url{https://jupyter.cs.aalto.fi/}
and reproduce the reported results. Minimise the use of non-standard Python packages to
ensure ease of execution and reproducibility.
\end{hint}
